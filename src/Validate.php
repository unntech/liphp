...
class Validate{
     ...
     * @return bool
     */
    public static function isInteger(mixed $val, bool $bigInt = false): bool
    {
        if (!is_numeric($val)) {
            return false;
        }
     ...
     * @return bool
     */
    public static function isNaturalNum(mixed $val): bool
    {
     ...
     * @return bool
     */
    public static function isOdd(mixed $val): bool
    {
     ...
     * @return bool
     */
    public static function isEven(mixed $val): bool
    {
        return self::isInteger($val) && boolval(!(intval($val) & 1));
    }
     ...
     * @return bool|array
     */
    public static function isBase64Image(string $val): bool|array
    {
