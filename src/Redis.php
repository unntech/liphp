...
class Redis {
    ...
    public static function geoadd(string $key, float $lng, float $lat, string $member, mixed ...$other_triples_and_options)
    {
    ...
    public static function hSet(string $key, string $member, mixed $value)
    {
    ...
    public static function lPush(string $key, mixed ...$elements)
    {
        return self::$redis->lPush(self::$pre.$key, ...$elements);
    }

    public static function rPush(string $key, mixed ...$elements)
    {
    ...
    public static function lSet(string $key, int $index, mixed $value)
    {
    ...
    public static function sAdd(string $key, mixed $value, mixed ...$other_values)
    {
    ...
    public static function sIsMember(string $key, mixed $value)
    {
    ...
    public static function zAdd(string $key, array|float $score_or_options, mixed ...$more_scores_and_mems)
    {
    ...
    public static function zRank(string $key, mixed $member)
    {
        return self::$redis->zRank(self::$pre.$key, $member);
    }

    public static function zRevRank(string $key, mixed $member)
    {
        return self::$redis->zRevRank(self::$pre.$key, $member);
    }

    public static function zRangeByScore(string $key, string|float $start, string|float $end, array $options = [])
    {
        return self::$redis->zRangeByScore(self::$pre.$key, $start, $end, $options);
    }

    public static function zRevRangeByScore(string $key, string|float $max, string|float $min, array|bool $options = [])
    {
        return self::$redis->zRevRangeByScore(self::$pre.$key, $max, $min, $options);
    }

    public static function zRange(string $key, string|int $start, string|int $end, array|bool|null $options = null)
    {
        return self::$redis->zRange(self::$pre.$key, $start, $end, $options);
    }

    public static function zRevRange(string $key, string|int $start, string|int $end, array|bool|null $options = null)
    {
        return self::$redis->zRevRange(self::$pre.$key, $start, $end, $options);
    }

    public static function zIncrBy(string $key, float $value, mixed $member)
    {
        return self::$redis->zIncrBy(self::$pre.$key, $value, $member);
    }

    public static function zRem(string $key, mixed $member, mixed ...$other_members)
    {
