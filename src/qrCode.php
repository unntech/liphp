...
class qrCode {
    ...
    {
        \LiPhpLib\QRcode::png($text, $outfile, $level, $size, $margin, $saveandprint, $back_color, $fore_color);
    }
    ...
    {
        \LiPhpLib\QRcode::svg($text, $outfile, $level, $size, $margin, $saveandprint, $back_color, $fore_color);
    }
    ...
    {
        \LiPhpLib\QRcode::eps($text, $outfile, $level, $size, $margin, $saveandprint, $back_color, $fore_color);
    }

    public static function text($text, $size = 10, $margin = 1, $level = 'L', $outfile = false)
    {
        return \LiPhpLib\QRcode::text($text, $outfile, $level, $size, $margin);
    }
